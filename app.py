...
def prediction_data():
    if request.method == 'GET':
        ...
        if result == 0:
            return render_template("result.html", final_result = "Your yearly income is less than $50000")
        elif result == 1:
            return  render_template("result.html", final_result = "Your yearly income is greater than $50000")
